...
KWORD_ROLE_EVELYN = "role_evelyn"  ---- 伊芙琳，星罗占影
...
ROLE_REGISTER_DICT = {
    ...
    [KWORD_ROLE_FERESHTEH] = {
        ...
        [KWORD_DIFFICULTY]  = EnumRoleDifficulty.NORMAL,
        [KWORD_PREFERENCE]  = EnumRolePreference.NO_PREFERENCE,
        [KWORD_NICKNAME]    = {"芙蕾什塔", "芙蕾", "神灯", "波斯", "商人"},
        [KWORD_ITEM]        = {
    ...
    [KWORD_ROLE_KASIM] = {
        ...
        [KWORD_DIFFICULTY]  = EnumRoleDifficulty.NORMAL,
        [KWORD_PREFERENCE]  = EnumRolePreference.GATHERING,
        [KWORD_NICKNAME]    = {"卡西姆", "阿里巴巴", "芝麻", "波斯", "商人"},
        [KWORD_ITEM]        = {
            [1] = {origin = EnumItemOrigin.DEV_DECK, prefix = PREFIX_RO_INT02, index = 12, loc_idx = 1},
            [2] = {origin = EnumItemOrigin.DEV_DECK, prefix = PREFIX_RO_INF02, index = 24, loc_idx = 2},
            [3] = {origin = EnumItemOrigin.DEV_DECK, prefix = PREFIX_RO_INF02, index = 25, loc_idx = 3},
        }
    },
    [KWORD_ROLE_LOUIS] = {
        [KWORD_ORDER]       = 25,
    ...
    [KWORD_ROLE_HOLLY] = {
        ...
        [KWORD_DIFFICULTY]  = EnumRoleDifficulty.NORMAL,
        [KWORD_PREFERENCE]  = EnumRolePreference.HUNTING,
        [KWORD_NICKNAME]    = {"荷莉", "哈利", "隐形", "复活", "魔杖"},
        [KWORD_ITEM]        = {
            [1] = {origin = EnumItemOrigin.DEV_DECK, prefix = PREFIX_RO_INT03, index = 2, loc_idx = 1},
    ...
    [KWORD_ROLE_EVELYN] = {
        ...
        [KWORD_DIFFICULTY]  = EnumRoleDifficulty.NORMAL,
        [KWORD_PREFERENCE]  = EnumRolePreference.NO_PREFERENCE,
        [KWORD_NICKNAME]    = {"伊芙琳", "占卜", "占星", "群星", "塔罗"},
        [KWORD_ITEM]        = {
            [1] = {origin = EnumItemOrigin.DEV_DECK, prefix = PREFIX_RO_INT03, index = 8, loc_idx = 1},
            [2] = {origin = EnumItemOrigin.DEV_DECK, prefix = PREFIX_RO_INF03, index = 15, loc_idx = 2},
            [3] = {origin = EnumItemOrigin.DEV_DECK, prefix = PREFIX_RO_INF03, index = 16, loc_idx = 3},
        }
    },
}