...
DEFAULT_ALL_COLOR_LIST = {
    DEFAULT_COLOR_RED, DEFAULT_COLOR_PURPLE, DEFAULT_COLOR_BLUE, DEFAULT_COLOR_YELLOW,
    DEFAULT_COLOR_BLACK, DEFAULT_COLOR_WHITE, DEFAULT_COLOR_GREY
}
...
NAME_BOARD_ROLE_DISCARD = "discard_board"
NAME_BOARD_ROLE_HAND = "hand_board"

-- variant
SCRIPT_VERSION = 2025071101
...
GUID_ROLE_DISCARD_BOARD_LIST = {
    [DEFAULT_COLOR_RED] = "2098ac",
    [DEFAULT_COLOR_PURPLE] = "9593a3",
    [DEFAULT_COLOR_BLUE] = "c290d9",
    [DEFAULT_COLOR_YELLOW] = "cdede9"
}
GUID_ROLE_HAND_BOARD_LIST = {
    [DEFAULT_COLOR_RED] = "25db50",
    [DEFAULT_COLOR_PURPLE] = "1d676d",
    [DEFAULT_COLOR_BLUE] = "b0614c",
    [DEFAULT_COLOR_YELLOW] = "3f4015"
}
