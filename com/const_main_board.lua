...
LIST_PARAM_ONLOAD_BUTTONS = {
    ...
    },
    {
        ...
        function_owner = self,
        width=DEFAULT_BUTTON_WIDTH, height=DEFAULT_BUTTON_HEIGHT,
        position={z=0.92, x=0.85, y=DEFAULT_BUTTON_LOCATION_Y}, rotation=DEFAULT_ROTATION, scale=DEFAULT_BUTTON_SCALE, font_size=DEFAULT_BUTTON_FONT_SIZE,
    ...
    },
    {
        ...
        function_owner = self,
        width=DEFAULT_BUTTON_WIDTH, height=DEFAULT_BUTTON_HEIGHT,
        position={z=0.92, x=0.45, y=DEFAULT_BUTTON_LOCATION_Y}, rotation=DEFAULT_ROTATION, scale=DEFAULT_BUTTON_SCALE, font_size=DEFAULT_BUTTON_FONT_SIZE,
